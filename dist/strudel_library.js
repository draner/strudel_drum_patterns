...
setcpm(140 / 4);
export const kit = "RolandTR808";
export const bass_key = "c";
export const bass_octave = 1;
export const bass_synth = "sawtooth";

export const drumLibrary = {
...
export function playPattern(pattern, bank = kit) {
  return pattern.bank(bank);
}