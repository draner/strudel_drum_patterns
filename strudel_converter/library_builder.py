...
def build_library(
    ...
    js_lines.append("")
    js_lines.append("  const bank = o.bank || o.kit || 'RolandTR808';")
    ...
    js_lines.append("      const nVal = typeof n === 'object' ? (n[instrument] ?? null) : (typeof n === 'number' && n > 0 ? n : null);")
    js_lines.append("      if (nVal !== null) {")
